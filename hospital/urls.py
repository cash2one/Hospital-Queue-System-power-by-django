...
urlpatterns = [
    ...
    url(r'^getdoctorcontent/$',views.ajax_used_to_doctor_content,name='ajax_used_to_doctor_content'),
    ...
    url(r'^huizhen_history_detail_index/(?P<id>\d+)/$', views.huizhen_history_detail_index, name='huizhen_history_detail_index'),
]